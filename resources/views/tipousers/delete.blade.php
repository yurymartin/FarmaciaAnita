{!! Form::open(['action' => ['TipouserController@destroy', $tipouser->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$tipouser->id}}" style="margin-top: 100px">
