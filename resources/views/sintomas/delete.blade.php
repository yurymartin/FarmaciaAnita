{!! Form::open(['action' => ['SintomaController@destroy', $sintoma->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$sintoma->id}}" style="margin-top: 100px">
