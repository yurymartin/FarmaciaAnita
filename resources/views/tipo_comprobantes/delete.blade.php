{!! Form::open(['action' => ['Tipo_ComprobanteController@destroy', $tipo_comprobante->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$tipo_comprobante->id}}" style="margin-top: 100px">
