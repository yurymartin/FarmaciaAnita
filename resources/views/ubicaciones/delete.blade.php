{!! Form::open(['action' => ['UbicacionController@destroy', $ubicacion->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$ubicacion->id}}" style="margin-top: 100px">
