...
{!! Form::open(['route'=>'especialidades.store', 'method'=>'POST', 'files' => false, 'role' => 'form']) !!}
{{ Form::token() }}
<div class="modal fade" id="modal-default">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Registrar una Nueva Especialidad</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="descripcion" rows="5" class="form-control"
                        placeholder="Ingrese la descripcion de la especialidad"></textarea>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
