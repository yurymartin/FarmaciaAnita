{!! Form::open(['action' => ['Tipo_ProductoController@destroy', $tipoproducto->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$tipoproducto->id}}" style="margin-top: 100px">
