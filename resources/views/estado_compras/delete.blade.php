{!! Form::open(['action' => ['Estado_CompraController@destroy', $estado_compra->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$estado_compra->id}}" style="margin-top: 100px">
