{!! Form::open(['action' => ['Estado_VentaController@destroy', $estado_venta->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$estado_venta->id}}" style="margin-top: 100px">
