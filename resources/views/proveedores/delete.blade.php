{!! Form::open(['action' => ['ProveedorController@destroy', $proveedor->id], 'method' => 'DELETE']) !!} 
{{ Form::token() }}
<div class="modal fade text-center" id="modal-eliminar-{{$proveedor->id}}" style="margin-top: 100px">
